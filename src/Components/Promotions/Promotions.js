...
function Promotion(){
    return(
        <div className="promotions">
            <PromotionsText class="promotions-header" text="splitkaro on the go" />
            <PromotionsText class="promotions-center" text="Get the free Splitkaro app and add IOUs from anywhere:" />
            ...
            <div className="promotions-footer">
                <PromotionsText class="promotions-footer-p" text="Copyright © 2020 Splitkaro Inc. All rights reserved." />
            </div>
        </div>
    )
}
